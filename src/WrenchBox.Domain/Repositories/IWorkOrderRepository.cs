...
public interface IWorkOrderRepository
{
    ...
    Task<(IReadOnlyList<WorkOrder> Items, int TotalCount)> GetPagedAsync(int page, int pageSize, WorkOrderStatus? status, Guid? customerId, CancellationToken cancellationToken = default);
